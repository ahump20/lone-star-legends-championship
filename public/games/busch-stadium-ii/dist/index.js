import { ACESFilmicToneMapping, Clock, Color, PCFSoftShadowMap, SRGBColorSpace, WebGLRenderer, } from 'three';
...
function configureRenderer(canvas) {
...
export function initializeBuschStadium(canvas, overrides = {}) {
    ...
    return {
        ...
        updateOptions: (options) => {
            ...
            const normalizedPalette = mergedOptions.crowd.palette.map((value) => new Color(value).getStyle());
            mergedOptions = {
                ...mergedOptions,
